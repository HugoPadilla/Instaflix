...
class TvShowRemoteMediatorFactoryImpl @Inject constructor(
    ...
    override fun create(category: CategoryTvShow): RemoteMediator<Int, TvShowEntity> {
        return when(category) {
            ...
            CategoryTvShow.POPULAR -> PopularTvShowRemoteMediator(tvShowApiService = tvShowApiService, moviesDatabase)
            CategoryTvShow.TOP_RATED -> TopRatedTvShowRemoteMediator(tvShowApiService = tvShowApiService, moviesDatabase)
        }
    }
}